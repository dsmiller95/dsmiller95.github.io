...
-- TODO: allow turning off of certain axis's keys
-- TODO: fix rotation of gridString method usage
...
-- TODO: make nonogram accept a partial solution in some cases, but still display correct grid key
<NonogramExample gridString={`
    XO
    OO
    `}/>
